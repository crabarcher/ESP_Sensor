...
// MQTT
const char* mqtt_server = "192.168.5.6";  // IP of the MQTT broker
const char* VOC_topic = "enviroment/VOC";
const char* CO2_topic = "enviroment/CO2";
const char* mqtt_username = "mqtt"; // MQTT username
const char* mqtt_password = "mqtt"; // MQTT password
const char* clientID = "VOC_C02"; // MQTT client ID
